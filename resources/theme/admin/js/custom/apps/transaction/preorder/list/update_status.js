...
var KTAppEcommerceUpdateStatus = function () {
    ...
    const initConditionsSelect2 = () => {
        ...
        const allConditionTypes = document.querySelectorAll('[data-kt-ecommerce-catalog-update-status-preorder="preorder_option"]');
    ...
    const handleSubmit = () => {
        ...
        // Get elements
        const submitButton = element.querySelector('[data-kt-preorders-modal-action="submit"]');
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        formSubmit = axios.post(
                            submitButton.closest('form').getAttribute('action') + '/' + param.get('preorder_id'),
                            param,
                            {
                                headers: {
    ...
    const initModalUpdateDiscount = () => {
        ...
        const cancelButton = element.querySelector('[data-kt-preorders-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[data-kt-preorders-modal-action="close"]');
