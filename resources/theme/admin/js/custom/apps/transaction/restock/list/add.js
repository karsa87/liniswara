...
var KTAppEcommerceSaveProduct = function () {
    ...
    const initQuill = () => {
        ...
        elements.forEach(element => {
            ...
            let restockDescription = document.querySelector('textarea[name="restock_description"]').value;
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        form.querySelector('textarea[name="restock_description"]').value = quill.root.innerHTML;
                        form.querySelector('textarea[name="restock_description"]').text = quill.root.innerHTML;
