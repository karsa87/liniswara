...
var KTUsersUpdatePermissions = function () {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        let roleId = form.querySelector("input[name='role_id']").value;
                        ...
                        axios.post(
                            submitButton.closest('form').getAttribute('action') + '/' + roleId,
                            param
    ...
    var handleEditRows = () => {
        ...
        const updateButtons = document.getElementsByClassName('update_row');
        ...
        updateButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Check axios library docs: https://axios-http.com/docs/intro
                axios.get(e.target.dataset.urlEdit).then(function (response) {
                    if (response && response.data) {
                        let role = response.data.data;
                        form.querySelector("input[name='role_id']").value = role.id;
                        form.querySelector("input[name='role_name']").value = role.name;
                        form.querySelector("textarea[name='role_description']").value = role.description;

                        role.permissions.forEach(function(permission) {
                            form.querySelector(`input[name='permissions[${permission.key}]']`).setAttribute('checked', "");
                        })
                        modal.show();
                    } else {
                        // Show error popup. For more info check the plugin's official documentation: https://sweetalert2.github.io/
