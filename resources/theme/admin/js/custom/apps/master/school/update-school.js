...
// Class definition
var KTUsersUpdateSchool = function () {
    // Shared variables
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        let schoolId = form.querySelector("input[name='school_id']").value;
                        ...
                        axios.put(
                            submitButton.closest('form').getAttribute('action') + '/' + schoolId,
