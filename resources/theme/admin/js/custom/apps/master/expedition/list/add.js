		...
		dropzone = new Dropzone("#kt_modal_add_update_expedition_logo", {
            ...
            init: function() {
                ...
                this.on("removedfile", function (file) {
                    if (document.querySelector("input[name='expedition_name']").value == '') {
                        return false;
                    }
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            axios.delete($('meta[name=file_delete_url]').attr("content") + '/' + document.querySelector('input[name="expedition_logo_id"]').value, {})
                            .then(response => {
                                if (response) {
                                    Swal.fire({
