...
var KTAreaSchoolsAdd = function () {
    ...
    var initAddAreaSchool = () => {
        $('[name="area_school_id"]').select2({
            dropdownParent: $('#kt_modal_add_area_school'),
            ajax: {
                url: $('[name="area_school_id"]').data('url'),
                dataType: 'json',
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        let formSubmit = null;
                        if (param.get('area_school_id') != null && param.get('area_school_id') != undefined  && param.get('area_school_id') != '') {
                            param.append('_method', 'PUT');

                            formSubmit = axios.post(
                                submitButton.closest('form').getAttribute('action-update') + '/' + param.get('area_school_id'),
                                param
                            )
                        } else {
