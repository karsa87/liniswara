                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex my-4">
                                        <a href="{{ route('marketing.transaction.detail', $i+1) }}" class="btn btn-sm btn-light me-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Name-->
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">CV Indra</a>
                                            <a href="#">
                                                <i class="ki-duotone ki-verify fs-1 text-primary">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-8">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="border border-gray-300 border-dashed rounded  w-20 py-3 px-4 me-6 mb-3">
                                                <!--begin::Number-->
                                                <div class="d-flex justify-content-start flex-column">
                                                    <spam class="text-gray-800 fw-bold mb-1 fs-4">28 Oktober 2023</span>
                                                    <span class="text-gray-700 fw-semibold d-block fs-6">INV-281023-0024</span>
                                                </div>
                                                <!--end::Number-->
                                            </div>
                                            <!--end::Stat-->
