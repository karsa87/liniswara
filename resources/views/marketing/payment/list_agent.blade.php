    ...
    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5 mb-xl-10">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_customers" data-rank-regency="{{ route('marketing.payment.trasaction_rank_regency', 'REPLACE') }}" data-rank-school="{{ route('marketing.payment.transaction_rank_school_agent', 'REPLACE') }}">
                    <thead>
