...
<div class="card">
    ...
    <div class="card-body py-4">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_orders" data-url="{{ route('order_sent.index.list') }}" data-url-delete="{{ route('order.delete') }}" data-url-edit="{{ route('order.detail') }}">
            <thead>
