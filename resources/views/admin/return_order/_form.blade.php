        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column gap-10">
                    ...
                    <div class="fv-row">
                        <!--begin::Label-->
                        <label class="required form-label">Status Retur</label>
                        <!--end::Label-->
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <table class="table">
                            ...
                            <tbody data-repeater-list="return_details" id="table-detail-body">
                                ...
                                <tr data-repeater-item="" data-id="1">
                                    ...
                                    <td>
                                        <input type="number" class="form-control mw-100 w-200px return_detail_qty" name="return_details[1][qty]" value="{{ $detail->qty }}" min="1" max="{{ ($detail->qty) }}" />
                                    </td>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-2">
                                ...
                                <!--end::Editor-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Tuliskan catatan dalam return order.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                        </div>
        ...
        <div class="d-flex justify-content-end">
            ...
            <button type="submit" id="kt_ecommerce_add_return_order_submit" class="btn btn-primary">
                <span class="indicator-label">Retur</span>
