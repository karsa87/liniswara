...
<div class="card">
    ...
    <div class="card-body py-4">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed table-striped fs-6 gy-5" id="kt_table_categorys" data-url="{{ route('category.index.list') }}" data-url-delete="{{ route('category.delete') }}" data-url-edit="{{ route('category.show') }}">
            <thead>
