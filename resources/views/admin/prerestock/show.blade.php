            ...
            <div class="card-body pt-0 fs-6">
                ...
                <div class="mb-7">
                    ...
                    <div class="mb-0">
                        <!--begin::Price-->
                        <span class="fw-semibold text-gray-600">
                            {{ $carbon->parse($prerestock->date)->isoFormat('dddd, D MMMM Y H:m') }}
                        </span>
                        <!--end::Price-->
                    </div>
                    <!--end::Details-->
                ...
                <div class="mb-10">
                    ...
                    <div class="mb-0">
                        <!--begin::Card expiry-->
                        <div class="fw-semibold text-gray-600">{{ optional($prerestock->branch)->name }}</div>
                        <!--end::Card expiry-->
                    </div>
                    <!--end::Details-->
                </div>
                ...
                <div class="mb-10">
                    ...
                    <div class="mb-0">
                        <!--begin::Card expiry-->
                        <div class="fw-semibold text-gray-600">{!! html_entity_decode($prerestock->notes) !!}</div>
                        <!--end::Card expiry-->
                    </div>
                    <!--end::Details-->
                </div>
                ...
                <!--begin::Actions-->
                <div class="mb-0">
                    <a href="{{ route('prerestock.index') }}" class="btn btn-primary" id="kt_subscriptions_create_button">Back Index</a>
                </div>
                <!--end::Actions-->
            </div>
            <!--end::Card body-->
