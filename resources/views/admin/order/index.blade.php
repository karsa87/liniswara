                    ...
                    <form action="{{ route('order.export') }}" id="kt_ecommerce_export_order_form">
                        ...
                        <div class="px-7 py-5" data-kt-order-table-export="form">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold select-export-order" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-order-table-filter="order" name="search_regency_id" data-url="{{ route('ajax.region.regency') }}">
