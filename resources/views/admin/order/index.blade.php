...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-order-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Cari Pesanan" />
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end me-1" data-kt-order-table-toolbar="base">
                ...
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="data-kt-menu-export-order">
                    <form action="{{ route('order.export') }}" id="kt_ecommerce_export_order_form">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="px-7 py-5" data-kt-order-table-export="form">
                            <!--begin::Input group-->
                            <div class="mb-10">
                                <label class="form-label fs-6 fw-semibold">Kota/Kabupaten</label>
                                <select class="form-select form-select-solid fw-bold select-export-order" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-order-table-filter="order" name="search_regency_id" data-url="{{ route('ajax.region.regency.list') }}">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold select-export-order" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-order-table-filter="order" name="search_customer_id" data-url="{{ route('ajax.customer.list') }}">
                                    <option value="" selected></option>
                                </select>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-order-table-export="export">Download</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Content-->
    ...
    <div class="card-body py-4">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed table-striped table-striped fs-6 gy-5" id="kt_table_orders" data-url="{{ route('order.index.list') }}" data-url-delete="{{ route('order.delete') }}" data-url-edit="{{ route('order.detail') }}" >
            <thead>
