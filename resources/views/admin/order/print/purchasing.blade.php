                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark fw-bolder text-end fs-7 pb-1 pt-1">{{ $util->format_currency($order->total_amount, 0, 'Rp. ') }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    @if ($order->tax)
                                    <tr>
                                        <td colspan="6" class="text-end fs-7 pb-1 pt-1">{{ \App\Enums\Preorder\TaxEnum::MAP_LABEL[$order->tax] }}</td>
