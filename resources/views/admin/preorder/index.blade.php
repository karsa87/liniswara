...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-preorder-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Cari Invoice" />
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end me-1" data-kt-product-table-toolbar="base">
                ...
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="data-kt-menu-export-preorder">
                    <form action="{{ route('preorder.export') }}" id="kt_ecommerce_export_preorder_form">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                        ...
                        <!--end::Separator-->
                        <!--begin::Content-->
                        <div class="px-7 py-5" data-kt-preorder-table-export="form">
                            <!--begin::Input group-->
                            <div class="mb-10">
                            ...
                            <div class="mb-10">
                                ...
                                <select class="form-select form-select-solid fw-bold select-export-preorder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-preorder-table-filter="preorder" name="search_customer_id" data-url="{{ route('ajax.customer.list') }}">
                                    <option value="" selected></option>
                                </select>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-preorder-table-export="export">Download</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Content-->
    ...
    <div class="card-body py-4">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed table-striped fs-6 gy-5" id="kt_table_preorders" data-url="{{ route('preorder.index.list') }}" data-url-delete="{{ route('preorder.delete') }}" data-url-edit="{{ route('preorder.detail') }}" >
            <thead>
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_update_status_preorder_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_status_preorder_header" data-kt-scroll-wrappers="#kt_modal_update_status_preorder_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-5 mb-2 d-none" id="div-paid-at">
                            ...
                            <div class="fv-row flex-row-fluid">
                                ...
                                <!--end::Label-->
                                <!--begin::Select2-->
                                <input id="kt_ecommerce_edit_preorder_paid_at" name="preorder_paid_at" placeholder="Select a date" class="form-control mb-2" value="" />
                                <!--end::Select2-->
                            </div>
                            <!--end::Input group-->
                        </div>
