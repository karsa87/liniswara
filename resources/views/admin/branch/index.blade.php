...
<div class="card card-flush">
    ...
    <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed table-striped fs-6 gy-5 mb-0" id="kt_branchs_table" data-url="{{ route('branch.index.list') }}" data-url-delete="{{ route('branch.delete') }}">
            <thead>
