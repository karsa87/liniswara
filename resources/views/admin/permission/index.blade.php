...
<div class="card card-flush">
    ...
    <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed table-striped fs-6 gy-5 mb-0" id="kt_permissions_table" data-url="{{ route('permission.index.list') }}" data-url-delete="{{ route('permission.delete') }}">
            <thead>
