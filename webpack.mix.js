...
mix.combine('resources/theme/admin/js/custom/apps/master/setting/update-setting.js', 'public/assets/js/custom/apps/master/setting/update-setting.js');
mix.combine('resources/theme/admin/js/custom/apps/master/setting/list.js', 'public/assets/js/custom/apps/master/category/setting/list.js');
